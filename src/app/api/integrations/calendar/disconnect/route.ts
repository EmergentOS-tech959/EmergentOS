...
export async function POST() {
  try {
    ...
    try {
      console.log('[Calendar Disconnect] Regenerating briefing without Calendar...');
      await generateBriefingForUser({ userId });
      console.log('[Calendar Disconnect] Briefing regenerated successfully');
    } catch (briefingErr) {
      console.error('[Calendar Disconnect] Briefing regeneration failed:', briefingErr);
